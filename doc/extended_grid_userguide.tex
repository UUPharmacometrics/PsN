...
\title{Extended grid user guide\\ \vspace{2 mm} {\large PsN 3.6.2}}
\date{2013-05-28}
...
\begin{longtable}{p{1in}p{4in}}
\verb|-directory=extended_grid_dirN| & \\
\nopagebreak
...
Note: 'ID' in this table is hard coded and is not affected by option id\_column
Improvement: Replace ID based on  id\_column. Also add NOAPPEND NOPRINT ONEHEADER
