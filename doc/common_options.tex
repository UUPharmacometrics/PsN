...
\guidetitle{Common options PsN}{2015-02-13}
...
This document lists the options that 
are accepted by all PsN tools. However, depending on the tool, a particular option may have little effect. 
For example, the option -threads will not change the execution time unless you run more than one model. 
