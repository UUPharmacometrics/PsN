...
\guidetitle{CDD user guide}{2016-10-18}
...
The column on which the case-deletion is done. You can either use the name of the column as specified in the \mbox{\$INPUT} record in the model file or you can use the column number in the \mbox{\$INPUT} record. Numbering starts with 1. Default is ID.
\nextopt
\end{optionlist}
...
\nextopt
\optname{etas}
      Use the phi file of the original model as initial estimates for
      the etas.
\nextopt
\end{optionlist}
