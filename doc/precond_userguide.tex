...
\guidetitle{PRECOND\footnote{Yasunori Aoki, Rikard Nordgren, and Andrew C. Hooker: Preconditioning of Nonlinear Mixed Models for Stabilisation of Variance-Covariance Matrix Computations, {\it The AAPS Journal}, DOI: 10.1208/s12248-016-9866-5}  user guide}{2016-02-03}
\usepackage{color}
\usepackage{amsmath}
\usepackage{tikz}
