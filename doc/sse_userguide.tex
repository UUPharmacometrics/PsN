...
\guidetitle{SSE user guide}{2015-04-10}
...
based on a SSE with full and reduced models performed with a single sample size. The procedure is described in 
\emph{Accelerating Monte-Carlo Power Studies through Parametric Power Estimation}, 
PAGE 23 (2014) Abstr 3263, Ueckert S, Karlsson MO, Hooker AC. 
