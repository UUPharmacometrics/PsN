...
\title{SSE user guide\\ \vspace{2 mm} {\large PsN 3.6.8}}
\date{2013-09-16}
...
\\
\verb|-alternative_models =alt1,alt2,alt3| & \\
\nopagebreak
...
\\
\verb|-in_filter=<comma-separated list of conditions>| & \\
\nopagebreak
...
\end{verbatim} \\
\\
\verb|-out_filter=<comma-separated list of conditions| & \\
\nopagebreak
...
\end{verbatim} \\
\\
\verb|-recompute=<raw results filename, including directory name>| & \\
\nopagebreak
