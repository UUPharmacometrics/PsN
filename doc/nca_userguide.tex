...
\guidetitle{NCA user guide}{2015-03-04}
...
The PsN NCA can feed the ncappc R package\cite{Chayan} with simulated data. It is based on the simulation part of the vpc/npc.
...
The ncappc R package has many options and it is generally
hard for PsN to have a good set of default plots. The current
template will only generate a very basic dv.plot. If you are
