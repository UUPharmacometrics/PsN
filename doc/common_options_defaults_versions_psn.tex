...
When a template file is available for the tool, the R script will always be generated and saved in the main
run directory. If R is configured in psn.conf or command 'R' is available and option -rplots is set > 0 the script will
...
and then in the directory set with option -template\_directory\_rplots. 
