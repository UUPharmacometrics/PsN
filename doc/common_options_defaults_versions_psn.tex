...
(note that the xml file also can be set with option -nmqual\_xml).
\nextopt
\optdefault{nmqual\_xml}{string}
Only relevant with option -nmqual and with NMQual8 and later. 
This is the file used as input to autolog.pl. By default PsN will use log.xml in the nmqual subdirectory of the NONMEM installation directory, but -nmqual\_xml can
