...
\guidetitle{Bootstrap user guide}{2015-10-01}
\begin{document}
...
If option -dofv is set, there will also be a plot of the dOFV distribution. 
...
\bibitem{Efron} B. Efron, {\em An Introduction to the Bootstrap}, Chap. \& Hall, London UK, 1993
\bibitem{Niebecker} R. Niebecker and M. O. Karlsson, {\em Are datasets for NLME models large enough for a bootstrap to provide reliable parameter uncertainty distributions?} PAGE 22 (2013) Abstr 2899 \mbox{www.page-meeting.org/?abstract=2899}.
\end{thebibliography}
...
my @limits = (10,5,1,0.1) percent
0.1,0.05,0.001,0.0001 fraction outside interval
use limit is half this to get lower fraction
0.05 0.025 0.0005 0.00005  frac
position is count values +1 times fraction  pos=(count+1)*frac
if this is lower than 1 then undef

minimum count is (1/frac)-1 = count
