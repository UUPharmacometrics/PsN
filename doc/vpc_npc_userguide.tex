...
\guidetitle{VPC and NPC user guide}{2016-04-04}
...
\nextopt
\optname{mix}
      Set a variable to be used for MIXNUM in mixture models.
      Easiest is to set 'MIXOUT=MIXNUM' in abbreviated code
      and use -mix=MIXOUT. Note that MIXNUM cannot directly
