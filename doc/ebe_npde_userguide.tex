...
\guidetitle{EBE\_NPDE user guide}{2015-10-01}
...
The ebe\_npde program is a tool for simulation-evaluation based diagnostics. The name of
the program is a little misleading since it does a lot more than compute npde:s for EBE:s. The principle is 
\begin{enumerate}
