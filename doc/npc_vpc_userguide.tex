...
\guidetitle{VPC and NPC user guide}
...
\nextopt
\optname{Either of 12 binning option combinations for independent variable}
...
\nextopt
\optdefault{lower\_bound}{either a number or a name of an independent variable}
