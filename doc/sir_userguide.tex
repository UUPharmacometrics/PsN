...
If output file (lst) exists, then it is important that the control stream copy at the top of the lst-file matches the actual input model in terms
of which parameters are estimated.
\begin{optionlist}
