...
\guidetitle{SIR user guide}{2015-09-03}
\usepackage{amsmath}
...
%restart functionality, add iterations (like sse). need new loop conditions in main loop start_iteration,
%  a 0th iteration that has number > 0 iteraion, etc
...
Diagnostic rplots for the last iteration of sir will be generated if 
option -rplots is set >0. The file names are PsN\_plots\_base.pdf
and (-rplots > 1) PsN\_plots\_extended.pdf.
