...
the generation of perturbed parameter vector $i$ is performed according to 
...
\item For all but the last iteration: A file boxcox\_covmatrix\_iteration\_i.cov with the Box-Cox space covariance matrix for iteration $i$,
or, if -no-boxcox was set on commandline, a file untransformed\_covmatrix\_iteration\_i.cov.
