...
\guidetitle{SIR user guide}{2016-05-04}
\usepackage{amsmath}
...
requires 
that R libraries
gplots, ggplot2, plyr, dplyr, caTools, reshape, gridExtra, RColorBrewer, tidyr, MCMCpack and stats4 are installed.
...
keeping the eigenvectors but inflating the too-low eigenvalues to just large enough.
