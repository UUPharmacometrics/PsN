...
\guidetitle{MCMP user guide}{2016-08-03}
...
\begin{enumerate}
\item a large dataset (e.g. 1000 individuals) is simulated with a full model, or a separate simulation model if model misspecification will be taken into account. Note: PsN will run the simulation, and attempt to automatically convert the full model to a simulation model if
