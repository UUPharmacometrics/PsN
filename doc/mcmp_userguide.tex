...
\guidetitle{MCMP user guide}{2014-05-20}
...
\bibitem{Vong} Camille Vong, Martin Bergstrand, Mats O. Karlsson, {\em Rapid sample size calculations for a defined likelihood ratio test-based power in mixed effects models}, PAGE, 2010
\end{thebibliography}
