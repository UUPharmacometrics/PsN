...
\usepackage{amsmath}
\guidetitle{FREM userguide}{2026-04-28}
\usepackage{hyperref}
\begin{document}
...
\optdefault{force\_posdef\_samples}{500}
    ...
    Default is 500
\nextopt
\optname{keep\_ids\_noobs}
    By default all individuals that have no observations will be removed in the FREM dataset. This option
    keeps these individuals in the dataset and adds FREM records as for other individuals.
\nextopt
\optdefault{log}{list}
