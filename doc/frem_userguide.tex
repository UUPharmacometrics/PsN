...
\usepackage{amsmath}
\guidetitle{FREM userguide}{2016-05-25}
...
Also, in the script it is currently assumed that
the only categorical covariate is SEX, that male is encoded with
1 and female with 2, and that male is the most common category.
