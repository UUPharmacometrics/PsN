...
\guidetitle{FREM userguide}{2015-12-10}
...
A comma-separated list of covariates, required. Names used in \$INPUT.
...
\item Count the number of \$OMEGA blocks used for parameter ETAs, N\_parameter\_blocks.
Any diagonal \$OMEGA of size N > 1 is counted as N separate \$OMEGA of size 1. 
...
THETA and OMEGA for PK parameters are FIXED in this model. Include \$COV.
\item Run Model 2.
...
On each copied line, set value in DV column to covariate value and FREMTYPE to a unique type-value for this covariate. 
