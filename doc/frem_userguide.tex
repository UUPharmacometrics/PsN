...
\guidetitle{FREM userguide}{2016-01-07}
...
A comma-separated list of categorical covariates that are to be transformed from
...
with updated initial estimates for OMEGA off-diagonals.
