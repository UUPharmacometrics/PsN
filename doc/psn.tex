...
\subsection{INPUT and \$INPUT}
The INPUT record is not supported. NM-TRAN allows INPUT without the dollar-sign and PsN will add this as options or code to the previous record potentially causing strange errors or worse. If \$INPUT was used PsN will give a nice error message.
