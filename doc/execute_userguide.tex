...
\guidetitle{EXECUTE user guide}{2016-05-05}
...
\nextopt
    ...
    \nextopt
    \optname{full\_block}
        Make the omega matrix into a full block before running the model.
        Any fixed omegas and/or BLOCK SAME have to be at the end.
    \nextopt
\end{optionlist}
