...
\guidetitle{SCM user guide}{2014-08-28}
...
\begin{optionlist}
\optconfig{base\_criteria\_values}{perl code}
...
Handle time-varying covariates when computing median and mean of covariates. Requires that W is defined in \$ERROR/\$PRED. Assume an ID has the following observations: a,b,c,d
