...
\nextopt
\optdefault{logit}{list of parameters}
...
\begin{optionlist}
\optdefault{missing\_data\_token}{}
...
\nextopt
\optdefault{error}{add,prop,propadd,user}
