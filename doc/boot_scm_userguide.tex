...
\guidetitle{BOOT\_SCM user guide}{2017-10-11}
...
The boot\_scm, or bootstrap of the scm program is an implementation of the method presented in \cite{Keizer2}.
The program depends heavily on the scm program, and all scm options except base\_ofv apply also to boot\_scm. Please refer to scm\_userguide.pdf for help on scm options.
