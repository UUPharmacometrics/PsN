...
; II:   dosing interval
; ARM:  either cohort 1 or 2-5 --for TTE model; cohort 1 is reference arm for hazard ratio
; CAPD: capecitabine dose (for plotting)
...
$SIMULATION (822826) (179919 UNIFORM) (148453 UNIFORM) ONLYSIMULATION 
