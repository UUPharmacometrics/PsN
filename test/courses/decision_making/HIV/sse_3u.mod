...
$SIGMA 0.042            ;0.04
$ESTIMATION MAXEVAL=99999 METHOD=1 INTER PRINT=5 SIGL=9 NSIG=3 NOABORT
$COV
;$SIMULATION (12344) ONLYSIMULATION SUBPROBLEMS=100    ;TRUE=INITIAL
$TABLE ID TIME DV PRED IPRED VIRB VIR NOPRINT ONEHEADER FILE=ssetab003u
