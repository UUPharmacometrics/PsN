...
IF (TREAT.EQ.1)EFF=1
INH2=(DOSE2/(ED502+DOSE2))*EFF


$DES
VI=POVC*A(2)
DADT(1)=LAMBDA - D*A(1) - (1-INH)*(1-INH2)*BETA*VI*A(1)
DADT(2)=QA*(1-INH)*(1-INH2)*BETA*VI*A(1)-DA0*A(2)+AL*A(3)
DADT(3)=(1-QA)*(1-INH)*(1-INH2)*BETA*VI*A(1)-DL*A(3)-AL*A(3)
...
$COV
;$SIMULATION (12344) ONLYSIMULATION SUBPROBLEMS=10    ;TRUE=INITIAL
$TABLE ID TIME DV PRED IPRED VIRB VIR NOPRINT ONEHEADER FILE=ssetab001u
