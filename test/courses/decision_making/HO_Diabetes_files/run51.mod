;; 1. Based on: 360
;; 2. Description: Full WT range, Normal D&E+PL, PPG, DRUG switch
...
$TABLE ID TIME CMT DV PRED IPRED CFB EFFW EFFB BF EHB HBA HBAO HBAOL 
EEFS DWTE TRT NOAPP NOPRINT ONEHEAD FILE=simtab51