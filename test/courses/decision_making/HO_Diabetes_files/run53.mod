;; 1. Based on: 360
;; 2. Description: Full WT range, No D&E+PL, No PPG, DRUG switch
...
EFFB = DRUG * 1; ((1 + EFB * (1 - EXP(-(LOG(2)/T50)*( TIME )))))
EFFW = 1 ; DPR * (100 - EF) / 100 ; effect of weight based on disease progression, effect of D&E and effect of placebo
...
EEFS DWTE TRT NOAPP NOPRINT ONEHEAD FILE=simtab53