$PROBLEM Weibull - ref:1250 test:825 N:500
$INPUT ID DAY WEEK OCMT ODV OEVID OAMT OADDL OII ARM CAPD
       FLG TIME DV EVID ECOG META TSR6 BASET TEST2 TEST3
       TEST4 TEST5 DID

$DATA data_20131014.csv IGN=@ IGNORE=(FLG.LT.1) IGNORE=(TEST5.LT.1) IGNORE=(DID.GT.500)
...
$ESTIM MAXEVAL=9999 METHOD=0 LIKE PRINT=1 MSFO=msfb4_alt1 SIGL=9 NSIG=3
$COV PRINT=E
