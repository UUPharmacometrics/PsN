...
my @command_list=(
	[get_command('execute')." run45.mod","task 1 od 2"],
	[get_command('vpc')." run45vpc.mod -samples=20 -seed=1234 -dir=vpc_45 -lst=run45.lst -nopred -dv=SMXH -levels=0.5,1.5,2.5","task 2 of 2"]
	);
