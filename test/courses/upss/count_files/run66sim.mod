...
$TABLE ID TIME NOPRINT ONEHEADER FILE=sdtab66sim
$TABLE ID CAV CAVH CON NOPRINT ONEHEADER FILE=cotab66sim
$TABLE ID DOSE NOPRINT ONEHEADER FILE=catab66sim
$TABLE ID ICL IV IKA NOPRINT ONEHEADER FILE=patab66sim
