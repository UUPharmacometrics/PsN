...
$ESTIM MAXEVAL=9999 METHOD=COND LAPLACE -2LL PRINT=1 MSFO=msf67
$COV PRINT=E

$TABLE ID TIME NOPRINT ONEHEADER FILE=sdtab67
$TABLE ID CAV CAVH CON NOPRINT ONEHEADER FILE=cotab67
$TABLE ID DOSE NOPRINT ONEHEADER FILE=catab67
$TABLE ID ICL IV IKA NOPRINT ONEHEADER FILE=patab67
