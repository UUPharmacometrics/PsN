...
$COV PRINT=E
$TAB ID TVIS IPRED IWRES              ONEHEADER NOPRINT FILE=sdtab5
$TAB ID BASE IOV                      ONEHEADER NOPRINT FILE=patab5
$TAB ID DOSE ICL                      ONEHEADER NOPRINT FILE=cotab5
$TAB ID TIME TAD DS                   ONEHEADER NOPRINT FILE=mytab5
