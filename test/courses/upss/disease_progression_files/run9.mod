...
$COV PRINT=E
$TAB ID TVIS IPRED IWRES              ONEHEADER NOPRINT FILE=sdtab9
$TAB ID BASE IOV                      ONEHEADER NOPRINT FILE=patab9
$TAB ID DOSE ICL                      ONEHEADER NOPRINT FILE=cotab9
$TAB ID TIME TAD DS                   ONEHEADER NOPRINT FILE=mytab9
