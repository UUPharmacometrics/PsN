...
$COV PRINT=E
$TAB ID TVIS IPRED IWRES              ONEHEADER NOPRINT FILE=sdtab7
$TAB ID BASE IOV                      ONEHEADER NOPRINT FILE=patab7
$TAB ID DOSE ICL                      ONEHEADER NOPRINT FILE=cotab7
$TAB ID TIME TAD DS                   ONEHEADER NOPRINT FILE=mytab7
