...
$COV PRINT=E
$TAB ID TVIS IPRED IWRES              ONEHEADER NOPRINT FILE=sdtab4
$TAB ID BASE IOV                      ONEHEADER NOPRINT FILE=patab4
$TAB ID DOSE ICL                      ONEHEADER NOPRINT FILE=cotab4
$TAB ID TIME TAD DS                   ONEHEADER NOPRINT FILE=mytab4
