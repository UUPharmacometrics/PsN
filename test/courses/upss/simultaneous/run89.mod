...
$DES
 ...
 DADT(4) = BHAZ*EXP(-AGE*THETA(8))     ; Integrate hazard
...
IF(FLG.EQ.3)    IPRED = SUR*BHAZ*EXP(-THETA(8)*AGE)  ; Survival * hazard (S*h), conversion
