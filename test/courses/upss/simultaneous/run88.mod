...
$DES
 ...
 BHAZ = THETA(7)
 IF(T.GT.5.AND.T.LE.10) BHAZ = THETA(8) ; Hazard depends on TIME
 IF(T.GT.10) BHAZ = THETA(9)    
...
;------------TIME TO EVENT--------------     
  ...
  BHZ = THETA(7)
  IF(TIME.GT.5.AND.TIME.LE.10) BHZ = THETA(8) ; Hazard depends on TIME
  IF(TIME.GT.10) BHZ = THETA(9)
...
$THETA  (0,0.0400)       ; 7 BHAZ FOR CONVERSION, TIME <= 5
$THETA  (0,0.0400)       ; 8 BHAZ FOR CONVERSION, 5<TIME<=10
$THETA  (0,0.0400)       ; 9 BHAZ FOR CONVERSION, TIME > 10
