...
IF(FLG.EQ.3)    IPRED = SUR*BHAZ  ; Survival * hazard (S*h), conversion
...
$THETA  (0,0.0400)       ; 7 BHAZ FOR CONVERSION TRET=0
$THETA  (0,0.0400)       ; 8 BHAZ FOR CONVERSION TRET=1
