...
$ESTIM MAXEVAL=9999 METHOD=COND LAPLACE -2LL PRINT=1 MSFO=msf66
$COV PRINT=E

$TABLE ID TIME NOPRINT ONEHEADER FILE=sdtab66
$TABLE ID CAV CAVH CON NOPRINT ONEHEADER FILE=cotab66
$TABLE ID DOSE NOPRINT ONEHEADER FILE=catab66
$TABLE ID ICL IV IKA NOPRINT ONEHEADER FILE=patab66
