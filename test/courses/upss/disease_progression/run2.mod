...
;---------------- MODEL & PREDICTION NA ----------------------
 DS = BASE*(1+ALPHA*TIME/24/7)  ; Disease status
...
$COV PRINT=E
$TAB ID TVIS IPRED IWRES              ONEHEADER NOPRINT FILE=sdtab2
$TAB ID BASE IOV                      ONEHEADER NOPRINT FILE=patab2
$TAB ID DOSE ICL                      ONEHEADER NOPRINT FILE=cotab2
$TAB ID TIME TAD DS                   ONEHEADER NOPRINT FILE=mytab2
