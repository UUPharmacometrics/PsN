...
my @commands = 
	(
	 ...
	 get_command('lasso') . " $model_dir/mox1.mod -relations=CL:AGE-3,SEX-1,CRCL-2,,V:AGE-2,ACE-1,DIG-1,WT-2 -stratify_on=SEX -seed=790 -retries=0 -start_t=0.1 -step_t=0.05 -stop_t=0.15  ",
	);
