...
# Using so.pm
    ...
    is_deeply($so->SOBlock->[0]->Estimation->PopulationEstimates->MLE->columnType, [ 'structParameter', 'structParameter', 'varParameter variance', 'varParameter variance', 'varParameter variance' ], "Pheno: PopulationEstimates column types");
...
# pheno.lst without sdtab and patab
    ...
    is_deeply($so->SOBlock->[0]->Estimation->PopulationEstimates->MLE->columnType, [ ('structParameter') x 8, ('varParameter variance') x 3 ], "Nock: PopulationEstimates column types");
...
, "Nock: Correlation matrix MatrixRow");
    ...
    is_deeply($so->SOBlock->[0]->Estimation->PopulationEstimates->MLE->columnType, [ ('structParameter') x 8, 'varParameter stdev', 'varParameter correlation', ('varParameter stdev') x 3 ], "warfarin SAEM: PopulationEstimates column types");
    ...
    is_deeply($so->SOBlock->[0]->Estimation->PopulationEstimates->MLE->columnType, [ ('structParameter') x 5, 'varParameter variance' ], "DelBene: PopulationEstimates column types");
...
[ 5.23714E-01, 2.73184E-01, -2.07485E-01, -2.96282E-01, 1.28301E-02 ] ], "DelBene: Correlation matrix MatrixRow");
    ...
    is_deeply($so->SOBlock->[0]->Estimation->PopulationEstimates->MLE->columnType, [ ('structParameter') x 6, ('varParameter variance') x 2 ], "Simeoni: PopulationEstimates column types");
