...
; If the code spans multiple lines, all lines except the last on must
; have an \ at the end. Never set \ at the end of a configuration file comment, 
...
;The default lower, initial, upper values are -1000000,0.001,1000000
;which means it is not necessary to set values in the configuration file
;if the default values are good enough. In this example file all values are
;set as an illustration of the syntax.
...
;----------------------------------------------------------------------
;continuous linear theta lower bound 
;----------------------------------------------------------------------
