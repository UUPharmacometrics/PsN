...
;appear in the NONMEM code above. PsN will ignore the order of the original THETA numbers,
;it is only the order in which THETAs appear that is taken into account. 
;In this particular example the bounds and initial values are the same for all THETAs.
