...
```{r Observations_Individual.pred_Population.pred_vs.Time,results='hide',echo=FALSE,fig.width=9,fig.height=7,fig.keep="high",fig.align="center"}
if (is.null(subset.variable)){
...
```{r Observations_vs.Time,results='hide',echo=FALSE,fig.width=9,fig.height=7,fig.keep="high",fig.align="center"}
if (is.null(subset.variable)){
...
```{r Individual_predictions_vs.Time,results='hide',echo=FALSE,fig.width=9,fig.height=7,fig.keep="high",fig.align="center"}
if (is.null(subset.variable)){
...
```{r Population_predictions_vs.Time,results='hide',echo=FALSE,fig.width=9,fig.height=7,fig.keep="high",fig.align="center"}
if (is.null(subset.variable)){
