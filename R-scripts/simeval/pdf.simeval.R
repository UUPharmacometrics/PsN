pdf.simeval <- function(ebe.npde.file,iiv.eta.names,iov.eta.names,outlying_criteria,
  ...
  ###########################################   EBE.NPDE PLOTS  ################################################
  ebe.npde <- ebe.npde_all(ebe.npde.file,iiv.eta.names,iov.eta.names,outlying_criteria,
                           rplots.level,model.filename,make_plots=TRUE)
  
  ebe.npde_outliers <- ebe.npde$ebe.npde_outliers
  ID_deleted_ebe <- ebe.npde$ID_deleted_ebe
