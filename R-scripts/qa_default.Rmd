...
eta_table <- get_eta_values(working.directory=file.path(working.directory,"modelfit_run"),param_model="tdist")
...
if(make_boxcox_shape_plot) {
   boxcox_shape_plot <- plot_transformed_density(data_table=boxcox_shape_table,eta_table,param_model="boxcox")
...
if(make_tdist_shape_plot) {
   tdist_shape_plot <- plot_transformed_density(data_table=tdist_shape_table,eta_table,param_model="tdist")
