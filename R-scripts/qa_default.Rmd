...
extra_obs <- vpc::read_table_nm(paste0(working.directory,"/",sub('.mod.*','',model.filename),"_linbase.dta"))
obs <- cbind(obs,"DV"=extra_obs[,"DV"],"MDV"=extra_obs[,"MDV"])
add_cols <- obs[,c(resmod_suffix)]
sim <- vpc::read_table_nm(paste0(working.directory,"/simeval_run/m1/sim_res_table-1.dta"))
