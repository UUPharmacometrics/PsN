...
```
Unexplained variability in eta of parameters conditional on none, one or all covariates. That is the expected variability with a structural covariate-parameter relationship.
