...
```{r draw_structural_details_tables,echo=F,results='asis',warning=F}
...
```{r plot_outliers,echo=F,results='asis',fig.width=11,fig.height=7}
if(file.exists(file.path(working.directory,"simeval_run/raw_all_iofv.csv"))) {
  list_i_ofv_res <- i_ofv_res(file.path(working.directory,"simeval_run/raw_all_iofv.csv"))# calculation
