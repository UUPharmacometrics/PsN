...
ofv_table <- kable(ofv_table,booktabs=T,align=c("l","l"),linesep="") %>%
...
cat("#Overview\n\n")
overview_table <- kable(overview_table_list$overview_table,booktabs=T,longtable=T,align=c("l","r","c"),linesep="") %>%
...
if(list_par_var_models$fullblock_mod) {
  full_omega_block_table <- kable(full_omega_block_list$full_omega_block_table,booktabs=T,longtable=T,align = c("l","r","r"),linesep="") %>%
    row_spec(0,bold=T) %>%
    kable_styling(position="c",full_width = F) %>%
...
boxcox_lambdas_table <- kable(boxcox_lambdas_list$param_extra_table,booktabs=T,longtable=T,align = c("l","r","r","r"),linesep="") %>%
  row_spec(0,bold=T) %>%
  kable_styling(position="c",full_width = F) %>%
...
cat("##Additional etas\n\n")
if(list_par_var_models$add_etas_mod) {
  add_etas_table <- kable(add_etas_list$add_etas_table,booktabs=T,longtable=T,align = c("l","r","r","r"),linesep="") %>%
    row_spec(0,bold=T) %>%
    kable_styling(position="c",full_width = F) %>%
...
cat("##t-distribution\n\n")
tdist_table <- kable(tdist_list$param_extra_table,booktabs=T,longtable=T,align = c("l","r","r","r"),linesep="") %>%
  row_spec(0,bold=T) %>%
  kable_styling(position="c",full_width = F) %>%
...
if(list_par_var_models$iov_mod) {
  iov_table <- kable(iov_list$iov_table,booktabs=T,longtable=T,align = c("l","r","r","r"),linesep="") %>%
    row_spec(0,bold=T) %>%
    kable_styling(position="c",full_width = F) %>%
...
covariates_extra_table <- kable(covariates_table_list$covariates_extra_table,booktabs=T,longtable=T,linesep="",align = align) %>%
  row_spec(0,bold=T) %>%
  kable_styling(position="c",full_width = F) %>%
...
for (i in 1:length(resmod_table_list$dvid_nr)) {
  ...
  resmod_ruv_models_table <- kable(resmod_table_list$resmod_ruv_table_list[[i]],booktabs=T,longtable=T,align = c("l","r","c","l"),linesep="") %>%
      row_spec(0,bold=T) %>%
      kable_styling(position="c",full_width = F)
  ...
  if(!nonlinear && exists("xpdb")) {
    ...
    res_shrinkage <- kable(res_shrinkage,booktabs=T,longtable=T,linesep="",align = align) %>%
      row_spec(0,bold=T) %>%
      kable_styling(position="c",full_width = F)
    print(res_shrinkage)
...
ii_table <- kable(ii_list$ii_table,booktabs=T,longtable=T,align = c("l","r"),linesep="") %>%
      row_spec(0,bold=T) %>%
      kable_styling(position="c",full_width = F)
print(ii_table)
...
cat("\\pagebreak\n\n")
cat("#Outliers\n\n")
outliers_table <- kable(outlier_table_list$outliers_table,booktabs=T,longtable=T,align = c("l","r"),linesep="") %>%
      row_spec(0,bold=T) %>%
      kable_styling(position="c",full_width = F)
...
if(all_outl_list$files_exist) {
  simeval_overall_outliers_table <- kable(all_outl_list$all_outlier_table,booktabs=T,longtable=T,align = c("l","c","c","c","c","c"),linesep="") %>%
      row_spec(0,bold=T) %>%
      kable_styling(position="c",full_width = F)
...
if(file.exists(file.path(working.directory,"meta.yaml"))) {
  ...
  R_packages <- kable(add_info$R_packages,booktabs=T,longtable=T,align=c("l","l","l"),linesep="") %>%
    kable_styling(position="c",full_width = F) %>%
    row_spec(0,bold=T)
  print(R_packages)
}
