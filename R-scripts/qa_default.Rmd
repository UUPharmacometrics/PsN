...
if(boxcox_mod) {
  boxcox_lambdas_list <- get_boxcox_lambda_table(working.directory,list_par_var_models$dofv_box)
  boxcox_lambdas_orig <- boxcox_lambdas_list$boxcox_lambdas_orig
  boxcox_lambdas_table <- boxcox_lambdas_list$boxcox_lambdas_table
}
...
eta_table <- get_boxcox_eta_values(working.directory=file.path(working.directory,"modelfit_run"))
