...
if(all(skip!="resmod")) {
  ...
  resmod_structural_details <- resmod_structural_details_tables(working.directory,base_dataset,original_max0_model=original_max0_model,CWRES_table,idv_all,dvid_name,nonlinear)
}
```
