all_frem_plots <- function(working.directory) {
  if(file.exists(file.path(working.directory,"/postfrem_run/covdata.csv")) &&
    ...
    if(file.exists(file.path(working.directory,"/postfrem_run/frem_ratio.csv"))) {
      ...
      message("File ",file.path(working.directory,"/postfrem_run/frem_ratio.csv")," not found!")
    }
    if(file.exists(file.path(working.directory,"/postfrem_run/frem_id_ratios.csv"))) {
      ...
      message("File ",file.path(working.directory,"/postfrem_run/frem_id_ratios.csv")," not found!")
    }
    if(file.exists(file.path(working.directory,"/postfrem_run/sd_coefficients_summary.csv"))) {
      ...
      message("File ",file.path(working.directory,"/postfrem_run/sd_coefficients_summary.csv")," not found!")
    }
  }
}