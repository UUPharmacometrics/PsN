...
sub print_step {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> print_step');
# line 18 "lib/status_bar_subs.pm" 
	if ( $self->sofar == 0 ) {
		$output = '|';
	} else {
...
# line 136 libgen/status_bar.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> print_step');
	# End of Non-Dia code #
...
sub tick {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> tick');
# line 2 "lib/status_bar_subs.pm" 
...
# line 163 libgen/status_bar.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> tick');
	# End of Non-Dia code #
