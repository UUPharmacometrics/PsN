...
has 'comegas' => ( is => 'rw', isa => 'ArrayRef[Num]' );
...
has 'csigmas' => ( is => 'rw', isa => 'ArrayRef[Num]' );
has 'cvseomegas' => ( is => 'rw', isa => 'ArrayRef[Maybe[Value]]' );
has 'cvsesigmas' => ( is => 'rw', isa => 'ArrayRef[Maybe[Value]]' );
...
has 'initgrad' => ( is => 'rw', isa => 'ArrayRef[Num]' );
has 'iternum' => ( is => 'rw', isa => 'ArrayRef[Num]' );
has 'nom' => ( is => 'rw', isa => 'Num' );
has 'npofv' => ( is => 'rw', isa => 'Num' );
has 'npomegas' => ( is => 'rw', isa => 'ArrayRef[Num]' );
has 'npetabars' => ( is => 'rw', isa => 'ArrayRef[Num]' );
has 'nrom' => ( is => 'rw', isa => 'Num' );
has 'nth' => ( is => 'rw', isa => 'Num' );
has 'ofvpath' => ( is => 'rw', isa => 'ArrayRef[Num]' );
has 'ofv' => ( is => 'rw', isa => 'Num', clearer => 'clear_ofv' );
has 'dic' => ( is => 'rw', isa => 'Num' );
has 'omegacoordval' => ( is => 'rw', isa => 'HashRef[Num]' );
has 'seomegacoordval' => ( is => 'rw', isa => 'HashRef[Num]' );
has 'parameter_path' => ( is => 'rw', isa => 'ArrayRef[ArrayRef[Num]]' );
...
has 'sigmacoordval' => ( is => 'rw', isa => 'HashRef[Num]' );
has 'sesigmacoordval' => ( is => 'rw', isa => 'HashRef[Num]' );
...
has 'minimization_message' => ( is => 'rw', isa => 'ArrayRef[Str]', default => sub { [] } );
has 'thetacoordval' => ( is => 'rw', isa => 'HashRef[Num]' );
has 'sethetacoordval' => ( is => 'rw', isa => 'HashRef[Num]' );
...
has 't_matrix' => ( is => 'rw', isa => 'ArrayRef[ArrayRef]' );
has 'estimated_thetas' => ( is => 'rw', isa => 'ArrayRef[Bool]', default => sub { [] } );
has 'estimated_omegas' => ( is => 'rw', isa => 'ArrayRef[Bool]', default => sub { [] } );
has 'estimated_sigmas' => ( is => 'rw', isa => 'ArrayRef[Bool]', default => sub { [] } );
has 'parameter_significant_digits' => ( is => 'rw', isa => 'ArrayRef[Num]' );
...
has 'covariance_matrix' => ( is => 'rw', isa => 'ArrayRef[Num]' );
