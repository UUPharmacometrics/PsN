...
end cvsethetacoordval

start cvseomegacoordval
{
...
end cvseomegacoordval

start cvsesigmacoordval
{
...
end cvsesigmacoordval

start csigmacoordval
{
...
# {{{ get_NM7_table_numbers
start get_NM7_table_numbers
{
...
end get_NM7_table_numbers
# }}} get_NM7_table_numbers


# {{{ get_NM7_table_method
start get_NM7_table_method
{
...
end get_NM7_table_method
# }}} get_NM7_table_method

# {{{ get_NM7_tables
start get_NM7_tables
{
...
# {{{ get_NM7_tables_all_types
start get_NM7_tables_all_types
{
...
# {{{ permute_and_clean_rows
start permute_and_clean_rows
{
...
end permute_and_clean_rows
# }}} permute_and_clean_rows

# {{{ get_column_index_order
start get_column_index_order
{
	#must be done after raw
	unless ($self->NM7_parsed_raw()) {
...
end get_column_index_order
# }}} get_column_index_order


# {{{ parse_NM7_additional
start parse_NM7_additional
{
	#must be done after raw
	unless ($self->NM7_parsed_raw()){
