...
end full_name_NM7_file

# }}} full_name_NM7_file

# {{{ store_NM7_output

start store_NM7_output
...
# {{{ _scan_to_subproblems

start _scan_to_subproblems
	$self -> estimation_step_initiated(0);
	$self -> estimation_step_run(0);
	my $meth_printed = 1;
