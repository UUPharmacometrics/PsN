...
# line 22 "lib/tool/npc_subs.pm" 
{
	if (defined $this->auto_bin_mode) {
		...
		if ($this->min_no_bins > $this->max_no_bins) {
  ...
  unless ( defined $this->orig_table) {
    ...
    if (defined $this->sim_model) {
      ...
      if (scalar (@{$this->models->[0]->problems}) > 2 ) {
			...
			$this->simprobnum(2) if ($this->have_tnpri());
			$this->origprobnum(2) if ($this->have_tnpri());
		}
	}

	if (defined $this->refstrat() and (defined $this->no_of_strata())){
				...
				foreach my $line ( @{$input_record->[0]} ) {
					...
					if ( $line =~ /([\w]+)=([\w]+)[^\w]/ ) {
						unless ($1 =~ /(SKIP|DROP)/ ) { #synonym
							$found_synonym = 1 if ($2 eq $this->dv);
							last;
						}
					}
				}
...
# line 2693 "lib/tool/npc_subs.pm" 
{
...
# line 1612 "lib/tool/npc_subs.pm" 
{
...
sub get_bin_boundaries_overlap_count {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> get_bin_boundaries_overlap_count');
# line 1652 "lib/tool/npc_subs.pm" 
{
  # input value_hash
...
# line 3222 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> get_bin_boundaries_overlap_count');
	# End of Non-Dia code #
...
sub get_bin_ceilings_from_count {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> get_bin_ceilings_from_count');
# line 1725 "lib/tool/npc_subs.pm" 
{
  # input value_hash
...
# line 3374 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> get_bin_ceilings_from_count');
	# End of Non-Dia code #
...
sub get_bin_boundaries_overlap_value {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> get_bin_boundaries_overlap_value');
# line 1837 "lib/tool/npc_subs.pm" 
{
...
# line 3446 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> get_bin_boundaries_overlap_value');
	# End of Non-Dia code #
...
sub get_bin_ceilings_from_value {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> get_bin_ceilings_from_value');
# line 1871 "lib/tool/npc_subs.pm" 
{
  # @data_column, @data_indices
...
# line 3532 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> get_bin_ceilings_from_value');
	# End of Non-Dia code #
...
sub index_matrix_binned_values {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> index_matrix_binned_values');
# line 1919 "lib/tool/npc_subs.pm" 
{
...
# line 3658 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> index_matrix_binned_values');
	# End of Non-Dia code #
...
# line 2742 "lib/tool/npc_subs.pm" 
{
  my $floor=int($number);
  my $rem=$number-$floor;
  if ($rem >= 0){
...
# line 2757 "lib/tool/npc_subs.pm" 
{
  my $floor=int($number);
  my $rem=$number-$floor;
  if ($rem > 0){
...
# line 2773 "lib/tool/npc_subs.pm" 
{
...
# line 2786 "lib/tool/npc_subs.pm" 
{
...
sub standard_deviation {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> standard_deviation');
# line 2799 "lib/tool/npc_subs.pm" 
{
...
# line 3922 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> standard_deviation');
	# End of Non-Dia code #
...
sub get_data_matrix {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> get_data_matrix');
# line 2006 "lib/tool/npc_subs.pm" 
{
...
# line 4448 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> get_data_matrix');
	# End of Non-Dia code #
...
sub get_tte_data {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> get_tte_data');
# line 2525 "lib/tool/npc_subs.pm" 
{
...
# line 4649 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> get_tte_data');
	# End of Non-Dia code #
...
# line 2500 "lib/tool/npc_subs.pm" 
{
...
sub create_binned_data {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> create_binned_data');
# line 3000 "lib/tool/npc_subs.pm" 
{
...
# line 4969 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> create_binned_data');
	# End of Non-Dia code #
...
sub do_predcorr_and_varcorr {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> do_predcorr_and_varcorr');
# line 3481 "lib/tool/npc_subs.pm" 
{
  #this is for one bin
...
# line 5112 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> do_predcorr_and_varcorr');
	# End of Non-Dia code #
...
sub create_mirror_and_plot_data {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> create_mirror_and_plot_data');
# line 3229 "lib/tool/npc_subs.pm" 
{
...
# line 5341 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> create_mirror_and_plot_data');
	# End of Non-Dia code #
...
sub reprint_mirror_and_plot_data {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> reprint_mirror_and_plot_data');
# line 3425 "lib/tool/npc_subs.pm" 
{
...
# line 5428 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> reprint_mirror_and_plot_data');
	# End of Non-Dia code #
...
sub create_stratified_data {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> create_stratified_data');
# line 2830 "lib/tool/npc_subs.pm" 
{
...
# line 5630 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> create_stratified_data');
	# End of Non-Dia code #
...
sub vpc_analyze {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> vpc_analyze');
# line 3714 "lib/tool/npc_subs.pm" 
{
...
# line 6786 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> vpc_analyze');
	# End of Non-Dia code #
...
sub npc_analyze {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> npc_analyze');
# line 5317 "lib/tool/npc_subs.pm" 
{
...
# line 6939 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> npc_analyze');
	# End of Non-Dia code #
...
sub get_npc_indices {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> get_npc_indices');
# line 5290 "lib/tool/npc_subs.pm" 
{
...
# line 7005 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> get_npc_indices');
	# End of Non-Dia code #
...
sub get_npc_result_labels {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> get_npc_result_labels');
# line 5268 "lib/tool/npc_subs.pm" 
{
...
# line 7064 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> get_npc_result_labels');
	# End of Non-Dia code #
...
sub subset_npc_analyze {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> subset_npc_analyze');
# line 4839 "lib/tool/npc_subs.pm" 
{
...
# line 7539 libgen/tool/npc.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> subset_npc_analyze');
	# End of Non-Dia code #
