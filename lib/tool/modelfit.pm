...
# line 208 "lib/tool/modelfit_subs.pm" 
    # Usage:
    # 
...

{
	...
	if( $this->run_on_lsf or
	    $this->run_on_ud or
	    $this->run_on_zink or
	    $this->run_on_torque or
	    $this->run_on_slurm or
	    $this->run_on_lsf_nmfe or
	    $this->run_on_sge_nmfe or
	    $this->run_on_sge ){
		$this->run_local(0);
	}
...
# line 258 libgen/tool/modelfit.pm 
...
# line 3793 "lib/tool/modelfit_subs.pm" 
    {
	...
	if( not $pid ){
	  ...
	  if ( -e $self->models->[$run]->outputs->[0]->full_name 
	    ...
	    if( not -e './NM_run' . ($run+1) . '/done' ){
	      ...
	      unless( defined $self->raw_nonp_results ) {
	  ...
	  unless( exists $queue_info{$run} ){
	    ...
	    # }}}
	      ...
	      $self->stop_motion_call(tool=>'modelfit',
				      message => "Did not have to copy model and input, this is a retry.")
		  if ($self->stop_motion()> 1);
	  }
	  ...
	  ui -> print( category => 'all',
	      ...
	      if ($started_all_models and $self->parent_threads <= 1  and 
		  not $self->verbose and not $started_all_models_print);
...
# line 1155 libgen/tool/modelfit.pm 
...
sub select_best_model {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> select_best_model');
# line 3432 "lib/tool/modelfit_subs.pm" 
{
...
# line 1496 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> select_best_model');
	# End of Non-Dia code #
...
sub get_retry_name {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> get_retry_name');
# line 1335 "lib/tool/modelfit_subs.pm" 
{
  $retry++;
  if (defined $crash){
...
# line 1556 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> get_retry_name');
	# End of Non-Dia code #
...
sub set_msfo_to_msfi {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> set_msfo_to_msfi');
# line 1354 "lib/tool/modelfit_subs.pm" 
    {
...
# line 1641 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> set_msfo_to_msfi');
	# End of Non-Dia code #
...
sub reset_msfo {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> reset_msfo');
# line 1404 "lib/tool/modelfit_subs.pm" 
    {
...
# line 1711 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> reset_msfo');
	# End of Non-Dia code #
...
sub cut_thetas {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> cut_thetas');
# line 1441 "lib/tool/modelfit_subs.pm" 
    { 
...
# line 1773 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> cut_thetas');
	# End of Non-Dia code #
...
sub prepare_raw_results {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> prepare_raw_results');
# line 552 "lib/tool/modelfit_subs.pm" 
      {
...
# line 1960 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> prepare_raw_results');
	# End of Non-Dia code #
...
sub print_raw_results {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> print_raw_results');
# line 703 "lib/tool/modelfit_subs.pm" 
{
...
# line 2032 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> print_raw_results');
	# End of Non-Dia code #
...
my %options_hash;
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> _get_run_options');
# line 4433 "lib/tool/modelfit_subs.pm" 
{ 
...
# line 2103 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> _get_run_options');
	# End of Non-Dia code #
...
sub ud_submit {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> ud_submit');
# line 1766 "lib/tool/modelfit_subs.pm" 
{
  my $script;
...
# line 2164 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> ud_submit');
	# End of Non-Dia code #
...
sub ud_monitor {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> ud_monitor');
# line 1794 "lib/tool/modelfit_subs.pm" 
{
...
# line 2232 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> ud_monitor');
	# End of Non-Dia code #
...
sub ud_retrieve {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> ud_retrieve');
# line 1830 "lib/tool/modelfit_subs.pm" 
{
  my $script;
  unless( defined $PsN::config -> {'_'} -> {'ud_nonmem'} ){
    if( $Config{osname} eq 'MSWin32' ) {
...
# line 2295 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> ud_retrieve');
	# End of Non-Dia code #
...
sub sge_submit {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> sge_submit');
# line 1861 "lib/tool/modelfit_subs.pm" 
{
...
# line 2412 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> sge_submit');
	# End of Non-Dia code #
...
sub sge_nmfe_submit {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> sge_nmfe_submit');
# line 1907 "lib/tool/modelfit_subs.pm" 
{
  ...
  my $background = '' if ($PsN::nm_major_version == 6);
...
# line 2522 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> sge_nmfe_submit');
	# End of Non-Dia code #
...
sub lsf_nmfe_submit {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> lsf_nmfe_submit');
# line 1568 "lib/tool/modelfit_subs.pm" 
{
#  print " lsf_nmfe submit\n";
  ...
  my $background = '-background';
  my $background = '' if ($PsN::nm_major_version == 6 or $PsN::nm_major_version == 5);
...
# line 2647 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> lsf_nmfe_submit');
	# End of Non-Dia code #
...
sub sge_monitor {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> sge_monitor');
# line 1978 "lib/tool/modelfit_subs.pm" 
{
...
# line 2697 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> sge_monitor');
	# End of Non-Dia code #
...
sub sge_nmfe_monitor {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> sge_nmfe_monitor');
# line 2227 "lib/tool/modelfit_subs.pm" 
{
...
# line 2747 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> sge_nmfe_monitor');
	# End of Non-Dia code #
...
sub lsf_nmfe_monitor {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> lsf_nmfe_monitor');
# line 1655 "lib/tool/modelfit_subs.pm" 
    {
...
# line 2810 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> lsf_nmfe_monitor');
	# End of Non-Dia code #
...
sub slurm_submit {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> slurm_submit');
# line 2098 "lib/tool/modelfit_subs.pm" 
{
...
# line 2958 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> slurm_submit');
	# End of Non-Dia code #
...
sub nmfe_setup {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> nmfe_setup');
# line 1994 "lib/tool/modelfit_subs.pm" 
{
  #in $nm_version
...
# line 3098 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> nmfe_setup');
	# End of Non-Dia code #
...
sub slurm_monitor {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> slurm_monitor');
# line 2206 "lib/tool/modelfit_subs.pm" 
{
  #squeue -j 12345, --jobs
...
# line 3154 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> slurm_monitor');
	# End of Non-Dia code #
...
sub zink_submit {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> zink_submit');
# line 1687 "lib/tool/modelfit_subs.pm" 
{
...
# line 3250 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> zink_submit');
	# End of Non-Dia code #
...
sub zink_monitor {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> zink_monitor');
# line 1746 "lib/tool/modelfit_subs.pm" 
{
  ## Specifies the top level directory of the Zink directory structure. Should be specified via psn.conf
  my $ZinkDir = $PsN::config -> {'_'} -> {'zink_dir'};
...
# line 3303 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> zink_monitor');
	# End of Non-Dia code #
...
sub lsf_monitor {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> lsf_monitor');
# line 1537 "lib/tool/modelfit_subs.pm" 
    {
      my $string = "bjobs $jobId 2>&1";
      my $stdout = `$string`;
...
# line 3366 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> lsf_monitor');
	# End of Non-Dia code #
...
sub torque_submit {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> torque_submit');
# line 2246 "lib/tool/modelfit_subs.pm" 
{
  my $fsubs = join( ',' , @{$model -> subroutine_files} );
...
# line 3459 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> torque_submit');
	# End of Non-Dia code #
...
sub torque_monitor {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> torque_monitor');
# line 2304 "lib/tool/modelfit_subs.pm" 
{
...
# line 3517 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> torque_monitor');
	# End of Non-Dia code #
...
sub run_nonmem {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> run_nonmem');
# line 2330 "lib/tool/modelfit_subs.pm" 
{
...
# line 3867 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> run_nonmem');
	# End of Non-Dia code #
...
sub restart_needed {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> restart_needed');
# line 2645 "lib/tool/modelfit_subs.pm" 
{
...
# line 4702 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> restart_needed');
	# End of Non-Dia code #
...
sub compute_iofv {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> compute_iofv');
# line 4500 "lib/tool/modelfit_subs.pm" 
{
  my $queue_info_ref = $parm{'queue_info'};
...
# line 4752 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> compute_iofv');
	# End of Non-Dia code #
...
sub run_nmtran {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> run_nmtran');
# line 376 "lib/tool/modelfit_subs.pm" 
{
#	print "running nmtran\n";
	$ok=1;
...
# line 4784 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> run_nmtran');
	# End of Non-Dia code #
...
sub compute_cwres {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> compute_cwres');
# line 4471 "lib/tool/modelfit_subs.pm" 
	my $queue_info_ref = $parm{'queue_info'};
	croak "queue_info is not defined" unless defined $queue_info_ref;
...
# line 4846 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> compute_cwres');
	# End of Non-Dia code #
...
sub copy_model_and_input {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> copy_model_and_input');
# line 850 "lib/tool/modelfit_subs.pm" 
{
...
# line 5151 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> copy_model_and_input');
	# End of Non-Dia code #
...
sub write_tbs_files {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> write_tbs_files');
# line 783 "lib/tool/modelfit_subs.pm" 
    {
      my $file ='contr.txt';
      open( FILE, '>'.$file );
...
# line 5251 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> write_tbs_files');
	# End of Non-Dia code #
...
sub copy_model_and_output {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> copy_model_and_output');
# line 1122 "lib/tool/modelfit_subs.pm" 
{
#    print "copy_model_and_output\n";
...
# line 5498 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> copy_model_and_output');
	# End of Non-Dia code #
...
sub lsf_submit {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> lsf_submit');
# line 1470 "lib/tool/modelfit_subs.pm" 
    {
...
# line 5600 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> lsf_submit');
	# End of Non-Dia code #
...
sub calculate_raw_results_width {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> calculate_raw_results_width');
# line 401 "lib/tool/modelfit_subs.pm" 
  {
    # 2008-01-24
...
# line 5804 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> calculate_raw_results_width');
	# End of Non-Dia code #
...
sub print_finish_message {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> print_finish_message');
# line 3738 "lib/tool/modelfit_subs.pm" 
    {
      my $ui_text;
      # Log the run
...
# line 5891 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> print_finish_message');
	# End of Non-Dia code #
...
sub create_sub_dir {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> create_sub_dir');
# line 769 "lib/tool/modelfit_subs.pm" 
    {
	my $file;
...
# line 5939 libgen/tool/modelfit.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> create_sub_dir');
	# End of Non-Dia code #
