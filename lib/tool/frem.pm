...
sub BUILD
{
    ...
    my $code = "from pharmpy.tools.frem.method import setup; print(setup(" . PsN::path_literal($model->full_name) . ',' . PsN::python_array($self->covariates) . "))";
...
sub modelfit_setup
{
    ...
    my $code = "from pharmpy.tools.frem.method import update_model3b_for_psn; update_model3b_for_psn(" . PsN::path_literal($frem_dir) . ", $ncov)";
