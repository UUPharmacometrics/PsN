...
# line 18 "lib/tool/lasso_subs.pm" 
...
my %statistics;
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> calculate_covariate_statistics');
# line 145 "lib/tool/lasso_subs.pm" 
{
...
# line 622 libgen/tool/lasso.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> calculate_covariate_statistics');
	# End of Non-Dia code #
...
my %categories;
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> get_categories');
# line 109 "lib/tool/lasso_subs.pm" 
{
...
# line 696 libgen/tool/lasso.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> get_categories');
	# End of Non-Dia code #
...
sub parse_row {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> parse_row');
# line 233 "lib/tool/lasso_subs.pm" 
{
  my $variable_name;
  my $len;
  my $tmp_str;
...
# line 786 libgen/tool/lasso.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> parse_row');
	# End of Non-Dia code #
...
sub setup_lasso_model {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> setup_lasso_model');
# line 1209 "lib/tool/lasso_subs.pm" 
{
...
# line 1139 libgen/tool/lasso.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> setup_lasso_model');
	# End of Non-Dia code #
...
sub xv_step_init {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> xv_step_init');
# line 898 "lib/tool/lasso_subs.pm" 
{
 print "\nlasso: xv_step_init\n" if ($self->stop_motion());
...
# line 1237 libgen/tool/lasso.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> xv_step_init');
	# End of Non-Dia code #
...
sub xv_step_analyze {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> xv_step_analyze');
# line 963 "lib/tool/lasso_subs.pm" 
{
...
# line 1492 libgen/tool/lasso.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> xv_step_analyze');
	# End of Non-Dia code #
...
# line 100 "lib/tool/lasso_subs.pm" 
{
...
# line 1537 libgen/tool/lasso.pm 
...
# line 287 "lib/tool/lasso_subs.pm" 
{
  ui -> print( category => 'lasso',
...
# line 2218 libgen/tool/lasso.pm 
...
# line 1539 "lib/tool/lasso_subs.pm" 
{
...
# line 2318 libgen/tool/lasso.pm 
...
# line 1524 "lib/tool/lasso_subs.pm" 
{
...
# line 2397 libgen/tool/lasso.pm 
