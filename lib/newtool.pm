...
has 'run_on_umbrella' => ( is => 'rw', isa => 'Bool', default => 0 );
has 'expected_run_time' => ( is => 'rw', isa => 'Num', default => 5 );
has 'umbrella_timeout' => ( is => 'rw', isa => 'Num', default => 360 );
has 'crash_restarts' => ( is => 'rw', isa => 'Int', default => 4 );
has 'run_on_ud' => ( is => 'rw', isa => 'Bool', default => 0 );
has 'run_on_sge' => ( is => 'rw', isa => 'Bool', default => 0 );
has 'run_on_sge_nmfe' => ( is => 'rw', isa => 'Bool', default => 0 );
has 'run_on_lsf_nmfe' => ( is => 'rw', isa => 'Bool', default => 0 );
