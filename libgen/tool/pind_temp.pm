...
# line 344 "lib/tool/pind_subs.pm" 

# line 572 libgen/tool/pind.pm 
...
# line 309 "lib/tool/pind_subs.pm" 
{
...
# line 353 "lib/tool/pind_subs.pm" 
{
...
sub scale_vector {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> scale_vector');
# line 397 "lib/tool/pind_subs.pm" 
{
  #input $vector is reference to single-dimension array
...
# line 748 libgen/tool/pind.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> scale_vector');
	# End of Non-Dia code #
...
sub get_raw_ofv_vector {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> get_raw_ofv_vector');
# line 881 "lib/tool/pind_subs.pm" 
{
...
# line 835 libgen/tool/pind.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> get_raw_ofv_vector');
	# End of Non-Dia code #
...
sub create_iofvcont {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> create_iofvcont');
# line 495 "lib/tool/pind_subs.pm" 
{
...
# line 901 libgen/tool/pind.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> create_iofvcont');
	# End of Non-Dia code #
...
sub scale_exp_half_neg_vector {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> scale_exp_half_neg_vector');
# line 375 "lib/tool/pind_subs.pm" 
{
...
# line 956 libgen/tool/pind.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> scale_exp_half_neg_vector');
	# End of Non-Dia code #
...
sub column_sums {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> column_sums');
# line 419 "lib/tool/pind_subs.pm" 
{
...
# line 1028 libgen/tool/pind.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> column_sums');
	# End of Non-Dia code #
...
sub inverse_scale_columns {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> inverse_scale_columns');
# line 458 "lib/tool/pind_subs.pm" 
{
...
# line 1099 libgen/tool/pind.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> inverse_scale_columns');
	# End of Non-Dia code #
...
sub get_ind_ofv_matrix {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> get_ind_ofv_matrix');
# line 842 "lib/tool/pind_subs.pm" 
{
...
# line 1171 libgen/tool/pind.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> get_ind_ofv_matrix');
	# End of Non-Dia code #
...
sub get_jd_vector_eta_matrix {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> get_jd_vector_eta_matrix');
# line 531 "lib/tool/pind_subs.pm" 
{
...
# line 1294 libgen/tool/pind.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> get_jd_vector_eta_matrix');
	# End of Non-Dia code #
...
sub alt_get_jd_vector_eta_matrix {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> alt_get_jd_vector_eta_matrix');
# line 619 "lib/tool/pind_subs.pm" 
{
...
# line 1404 libgen/tool/pind.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> alt_get_jd_vector_eta_matrix');
	# End of Non-Dia code #
...
sub setup_ind_ofv_models {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> setup_ind_ofv_models');
# line 695 "lib/tool/pind_subs.pm" 
{
...
# line 1585 libgen/tool/pind.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> setup_ind_ofv_models');
	# End of Non-Dia code #
...
sub verify_ind_ofv_matrix {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> verify_ind_ofv_matrix');
# line 936 "lib/tool/pind_subs.pm" 
{
...
# line 1644 libgen/tool/pind.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> verify_ind_ofv_matrix');
	# End of Non-Dia code #
...
sub create_LxP_matrix_sum_LP_vector_P_values_matrix {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> create_LxP_matrix_sum_LP_vector_P_values_matrix');
# line 962 "lib/tool/pind_subs.pm" 
{
...
# line 1858 libgen/tool/pind.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> create_LxP_matrix_sum_LP_vector_P_values_matrix');
	# End of Non-Dia code #
...
sub verify_P_values_matrix {
	...
	# Start of Non-Dia code #
        'debug' -> warn(level => 3, message => "Entering \t" . ref($self). '-> verify_P_values_matrix');
# line 1142 "lib/tool/pind_subs.pm" 
{
...
# line 1963 libgen/tool/pind.pm 
        'debug' -> warn(level => 3, message => "Leaving \t" . ref($self). '-> verify_P_values_matrix');
	# End of Non-Dia code #
